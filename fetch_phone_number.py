...
from entities import phone_collection
from entities.phone_collection import PhoneCollection
    ...
    for sheet_name in sheet_names:
        ...
        for target_item in pd_data_value.index:
            for val in sheet_name['phone']:
                try:
                    for pn in phone_collection.phone_number(str(pd_data_value[val][target_item]).strip().lower()):
                        pc = PhoneCollection(None, None, None, None, None)
                        pc.phone_number = pn
